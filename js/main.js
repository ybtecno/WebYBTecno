...
//Ocultar / Mostrar (ver las caracteristicas)
  $("#lite").click(function() {
    $("#cont1").toggle(2000);
    },function(){ 
    $("#cont1").toggle(2000);
  ...
  $("#webEstandar").click(function() {
    $("#cont4").toggle(1000);
    },function(){ 
    $("#cont4").toggle(1000);
    });
  
  $("#onlineEstandar").click(function() {
    $("#cont5").toggle(1000);
    },function(){ 
    $("#cont5").toggle(1000);
    });

  $("#webAvanzado").click(function() {
    $("#cont6").toggle(1000);
    },function(){ 
    $("#cont6").toggle(1000);
    });

  $("#onlineAvanzada").click(function() {
    $("#cont7").toggle(1000);
    },function(){ 
    $("#cont7").toggle(1000);
    });

  $("#webPremium").click(function() {
    $("#cont8").toggle(1000);
    },function(){ 
    $("#cont8").toggle(1000);
    });

  $("#tiendaPremium").click(function() {
    $("#cont9").toggle(1000);
    },function(){ 
    $("#cont9").toggle(1000);
    });
